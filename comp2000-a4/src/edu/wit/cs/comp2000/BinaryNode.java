...
public class BinaryNode<T> {
    ...
    @return  A reference to this node's parent. */
	public BinaryNode<T> getParent() {
		return parent;
	} // end getParent

	/** Sets this node’s parent to a given node.
    @param newParent A node that will be the parent. */
	...
	public BinaryNode<T> copy() {
		...
		if (leftChild != null) {
			...
			newRoot.getLeftChild().setParent(newRoot);
		}
